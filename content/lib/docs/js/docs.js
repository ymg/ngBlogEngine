...
angular.module('DocsController', [])
    ...
    .controller('DocsController', [
        ...
        function ($scope, $rootScope, $location, $window, $cookies, openPlunkr, NG_PAGES, NG_NAVIGATION, NG_VERSION) {
...
angular.module('tutorials', [])
    ...
    .directive('docTutorialReset', function () {
        return {
            ...
            template: '<p><a href="" ng-click="show=!show;$event.stopPropagation()">Workspace Reset Instructions  ➤</a></p>\n' +
